...
data2 <- data %>% 
  filter(scenario %in% c("SSP2-Base-Plastics_S1",
                         "SSP2-NDC-Plastics_S1",
                         "SSP2-PkBudg1150-Plastics_S1",
                         "SSP2-PkBudg500-Plastics_S1"))

showAreaAndBarPlots(data2, items, tot)
```
